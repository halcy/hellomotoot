...
# Super secret values
TWILIO_NUMBER = "your telephone number"
TWILIO_NUMBER_DISP = "what you want the number to be rendered as in the UI"
TWILIO_AUTH_TOKEN = "twilio auth token. keep secret."
DB_FILE = "users.db"
SECRET_KEY = "for cookies signing. keep secret."
BASE_URL = "base URL to build links with."
